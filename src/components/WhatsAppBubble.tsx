...
export function WhatsAppBubble() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <div
        className={`absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-white text-[#333] text-sm font-sans px-4 py-2 rounded-lg shadow-lg whitespace-nowrap transition-all duration-300 ${
