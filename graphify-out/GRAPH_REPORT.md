...
4. `AGENTS.md Project Instructions` - 4 edges
5. `HeroSection Component Spec` - 4 edges
6. `getRecentPosts()` - 3 edges
7. `Clone Website Pipeline` - 3 edges
8. `NewConstructions Component Spec` - 3 edges
9. `Footer Component Spec` - 3 edges
10. `FeaturedListings Component Spec` - 3 edges
...
Cohesion: 0.22
Nodes (7): getAllPosts(), getPostBySlug(), getRecentPosts(), BlogPreview(), generateMetadata(), generateStaticParams(), sitemap()
