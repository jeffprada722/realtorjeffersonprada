...
## Corpus Check
- 24 files · ~446,787 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 126 nodes · 91 edges · 41 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.84)
...
2. `Header Component Spec` - 5 edges
3. `AGENTS.md Project Instructions` - 4 edges
4. `HeroSection Component Spec` - 4 edges
5. `Clone Website Pipeline` - 3 edges
6. `NewConstructions Component Spec` - 3 edges
7. `Footer Component Spec` - 3 edges
8. `FeaturedListings Component Spec` - 3 edges
9. `Original vs Clone Side-by-Side Comparison Screenshot` - 3 edges
10. `Avanti Way Logo White PNG Brand Asset` - 3 edges

## Surprising Connections (you probably didn't know these)
- `Header Navbar: Brand + Avanti Way Logo + Nav Links` --references--> `Realtor Realtor/REALTORS Logo White SVG Brand Asset`  [INFERRED]
  docs/research/components/header.spec.md → public/images/logo-realtor-white.svg
- `Clone Website Pipeline` --rationale_for--> `Original vs Clone Side-by-Side Comparison Screenshot`  [EXTRACTED]
  README.md → docs/design-references/comparison.png
- `Footer Component Spec` --references--> `Realtor Realtor/REALTORS Logo White SVG Brand Asset`  [EXTRACTED]
  docs/research/components/footer.spec.md → public/images/logo-realtor-white.svg
- `Multi-URL Clone Support` --rationale_for--> `Clone Website Pipeline`  [INFERRED]
  CHANGELOG.md → README.md
- `CI Quality Gates via GitHub Actions` --conceptually_related_to--> `AGENTS.md Project Instructions`  [INFERRED]
...
Cohesion: 0.18
Nodes (12): 1428 Brickell Slender Luxury Tower Street-Level Photo, Baccarat Residences Miami Aerial Night Skyline Photo, Cipriani Residences Curved Glass Tower Waterfront Rendering, Domus Brickell High-Rise Tower Rendering, House of Wellness Tower Concept Rendering Balconies, Lofty Brickell Concept Rendering Waterfront Tower, Mercedes-Benz Places Miami Twin Towers Rendering, ORA Casa Tua Brickell Tall Tower Rendering (+4 more)
...
- **Thin community `Community 16`** (2 nodes): `Home()`, `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 17`** (2 nodes): `PrivacyPage()`, `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 18`** (2 nodes): `handleSubmit()`, `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (2 nodes): `AccessibilityPage()`, `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (2 nodes): `AboutSection()`, `AboutSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (2 nodes): `Footer()`, `Footer.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 22`** (2 nodes): `WhatsAppBubble.tsx`, `WhatsAppBubble()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (2 nodes): `CtaBanner()`, `CtaBanner.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (2 nodes): `cn()`, `button.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (2 nodes): `utils.ts`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (2 nodes): `Multi-Platform AI Agent Support`, `Supported AI Agent Platforms`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 32`** (1 nodes): `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (1 nodes): `HeroSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (1 nodes): `Changelog Version History`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (1 nodes): `Use Cases: Platform Migration & Learning`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (1 nodes): `Next.js 16 Breaking Changes Warning`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (1 nodes): `Language Selector EN/ES/BR`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (1 nodes): `Layout Architecture Phase`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (1 nodes): `Tech Stack Analysis Phase`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `CTA Tagline: Turning Listings Into Landmarks One Home at a Time`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Page Sections: TopBar Header Hero Listings About NewConstructions CTA Footer` connect `Community 0` to `Community 4`, `Community 6`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Header Component Spec` connect `Community 4` to `Community 0`?**
